...
return [
    ...
    /*
     * The class name of the exception that will be thrown when the user
     * does not have the required permission/role.
     */

    'exception' => Spatie\Permission\Exceptions\UnauthorizedException::class,
    ...
    'cache' => [
        ...
        /*
         * The key to handle the cache key.
         */

        'key' => 'spatie.permission.cache',

        /*
         * The store to handle the cache.
         *
         * 'default'   => 'default',
         * 'store' => 'redis',
         */
