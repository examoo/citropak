...
const navigation = [
    ...
    },
    {
        ...
        children: [
            { name: 'Sales Report', href: 'sales-reports.index', permission: 'reports.view' },
            ...
            { name: 'Sub-Distributor Brand Wise Sales', href: 'sub-distributor-brand-sales-reports.index', permission: 'reports.view' },
            { name: 'Sub-Distributor Stock Wise Sales', href: 'sub-distributor-stock-sales-reports.index', permission: 'reports.view' },
...
<template>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                <template v-for="item in filteredNavigation" :key="item.name">
                    ...
                    <Link v-if="!item.children"
                        ...
                        <svg v-else-if="item.icon === 'globe'" class="w-5 h-5 flex-shrink-0" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                        </svg>
                        <!-- Calendar Icon (Holidays) -->
                        <svg v-else-if="item.icon === 'calendar'" class="w-5 h-5 flex-shrink-0" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <!-- Discount Icon -->
                        <svg v-else-if="item.icon === 'discount'" class="w-5 h-5 flex-shrink-0" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M7 7h.01M17 17h.01M7 17L17 7M10 7a3 3 0 11-6 0 3 3 0 016 0zM20 17a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                    ...
                    <!-- Dropdown Menu -->
                    <div v-else>
                        <button @click="toggleMenu(item.name)" :class="[
                            ...
                            <div class="flex items-center gap-3">
                                <!-- Admin Icon -->
                                <svg v-if="item.icon === 'admin'" class="w-5 h-5 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                </svg>
                                <!-- Orders Icon -->
                                <svg v-else-if="item.icon === 'orders'" class="w-5 h-5 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                                </svg>
                                <!-- Stock Icon -->
                                <svg v-else-if="item.icon === 'stock'" class="w-5 h-5 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                                </svg>
                                <!-- Invoice Icon -->
                                <svg v-else-if="item.icon === 'invoice'" class="w-5 h-5 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                                <!-- Reports Icon -->
                                <svg v-else-if="item.icon === 'reports'" class="w-5 h-5 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                                <!-- Box Icon (Product Management) -->
                                <svg v-else-if="item.icon === 'box'" class="w-5 h-5 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                                </svg>
                                <!-- Settings Icon -->
                                <svg v-else-if="item.icon === 'settings'" class="w-5 h-5 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <!-- Customer Icon -->
                                <svg v-else-if="item.icon === 'customer'" class="w-5 h-5 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                </svg>
                        ...
                        <!-- Submenu -->
                        <div v-if="isSidebarOpen && isExpanded(item.name)"
                            ...
                            <Link v-for="child in item.children" :key="child.name"
                                ...
                                <!-- Cube Icon (Products) -->
                                <svg v-if="child.icon === 'cube'" class="w-4 h-4 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                                </svg>
                                <!-- Tag Icon (Types/Category) -->
                                <svg v-else-if="child.icon === 'tag'" class="w-4 h-4 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                                </svg>
                                <!-- Users Icon -->
                                <svg v-else-if="child.icon === 'users'" class="w-4 h-4 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                </svg>
                                <!-- Document Icon -->
                                <svg v-else-if="child.icon === 'document'" class="w-4 h-4 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                                <!-- Globe Icon (Channel) -->
                                <svg v-else-if="child.icon === 'globe'" class="w-4 h-4 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                                </svg>
                                <!-- Truck Icon (Distribution) -->
                                <svg v-else-if="child.icon === 'truck'" class="w-4 h-4 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                                </svg>
                                <!-- Map Icon (Routes) -->
                                <svg v-else-if="child.icon === 'map'" class="w-4 h-4 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                                </svg>
                                <!-- Folder Icon (Categories) -->
                                <svg v-else-if="child.icon === 'folder'" class="w-4 h-4 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                                </svg>
                                <!-- Percent Icon (Schemes) -->
                                <svg v-else-if="child.icon === 'percent'" class="w-4 h-4 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M7 7h.01M17 17h.01M7 17L17 7M10 7a3 3 0 11-6 0 3 3 0 016 0zM20 17a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                <!-- Calendar Icon (Holidays) -->
                                <svg v-else-if="child.icon === 'calendar'" class="w-4 h-4 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                <!-- Target Icon (Set Targets) -->
                                <svg v-else-if="child.icon === 'target'" class="w-4 h-4 flex-shrink-0" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div :class="['transition-all duration-300 print:ml-0', isSidebarOpen ? 'ml-64' : 'ml-20']">
            <!-- Top Header -->
            <header
                class="sticky top-0 z-40 bg-white/80 backdrop-blur-xl border-b border-gray-200/50 shadow-sm print:hidden">
                <div class="flex items-center justify-between h-16 px-6">
                    <!-- Logo/Brands + Distribution Toggle -->
                    <div class="flex items-center gap-6">
                        <div class="flex items-center gap-2">
                            <div
                                class="w-8 h-8 rounded-lg bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center">
                        ...
                        <div class="relative" v-if="distributions.length > 0">
                            <button @click="!page.props.auth.user.distribution_id ? toggleDistributionDropdown() : null"
                                :class="[
                            ...
                            <!-- Dropdown -->
                            <div v-if="isDistributionDropdownOpen"
                                ...
                                <button @click="switchDistribution(null)" :class="[
                                    ...
                                    <span
                                        class="px-2 py-0.5 bg-purple-100 text-purple-700 rounded text-xs font-semibold">ALL</span>
                                    <span>All Distributions</span>
                                    <svg v-if="!currentDistribution || !currentDistribution.id"
                                        class="w-4 h-4 ml-auto text-purple-500" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <button v-for="dist in distributions" :key="dist.id" @click="switchDistribution(dist)"
                                    :class="[
                                        'w-full flex items-center gap-3 px-4 py-2.5 text-sm transition-colors',
                                    ...
                                    <span
                                        class="px-2 py-0.5 bg-indigo-100 text-indigo-700 rounded text-xs font-semibold">{{
                                            dist.code }}</span>
                                    <span>{{ dist.name }}</span>
                                    <svg v-if="currentDistribution && currentDistribution.id === dist.id"
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative pl-4 border-l border-gray-200">
                            <button id="user-dropdown-trigger" @click="toggleUserDropdown"
                                class="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity">
                                <div
                                    class="w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white font-medium text-sm shadow-lg shadow-indigo-500/30">
                                ...
                                <svg class="w-4 h-4 text-gray-400" :class="{ 'rotate-180': isUserDropdownOpen }"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                            ...
                            <!-- Dropdown Menu -->
                            <div v-if="isUserDropdownOpen" id="user-dropdown"
                                class="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
                                <!-- User Info -->
                                <div class="px-4 py-3 border-b border-gray-100">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-12 h-12 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-indigo-500/30">
                                            {{ page.props.auth.user.name.charAt(0).toUpperCase() }}
                                        </div>
                                        <div>
            ...
            <main class="p-6 relative min-h-[calc(100vh-4rem)]">
                ...
                <div v-if="isLoading"
                    class="absolute inset-0 z-50 flex items-center justify-center bg-slate-50/50 backdrop-blur-sm transition-opacity duration-300">
                    <div class="flex flex-col items-center gap-3">
                        <div
                            class="w-10 h-10 border-4 border-emerald-500/30 border-t-emerald-600 rounded-full animate-spin">
                        </div>
