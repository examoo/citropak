...
import CustomerDiscountModal from '@/Components/CustomerDiscountModal.vue';
...
const selectedCustomerForDiscount = ref(null);

const openDiscountModal = (customer) => {
    selectedCustomerForDiscount.value = customer.id;
    isDiscountModalOpen.value = true;
};

const closeDiscountModal = () => {
    isDiscountModalOpen.value = false;
    selectedCustomerForDiscount.value = null;
};
...
<template>
                            ...
                            <tr v-for="customer in customers.data" :key="customer.id"
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <button @click="openDiscountModal(customer)"
    ...
    <CustomerDiscountModal 
        ...
        :customerId="selectedCustomerForDiscount"
